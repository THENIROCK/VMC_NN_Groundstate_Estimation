...
begin
    ...
    # helper constructor
    function Ansatz(hidden_dim::Int=64)
        return Ansatz(Chain(
            Dense(3, hidden_dim, tanh),
...
begin
    function local_kinetic(ans::Ansatz, a, b, c)
        ...
        lap   = H[1,1] + H[2,2] + H[3,3] #laplacian 
...
### Monte Carlo estimate of ⟨H⟩ using score‐function gradients
begin
    function energy(ans::Ansatz, ν; nsamples=1000)
        ...
        for _ in 1:nsamples
            # propose (a,b,c) from a simple Gaussian prior
            a, b, c, d = randn(), randn(), randn(), randn()
            X1 = [a  0;
                  0  b]
            X2 = [0     im*c;
                  -im*c  0]
...
### Train the NN ansatz by minimizing ⟨H⟩
...
manifest_format = "2.0"
project_hash = "a68a99b8cddfd0efe52e11a478b79b110291fc9e"
